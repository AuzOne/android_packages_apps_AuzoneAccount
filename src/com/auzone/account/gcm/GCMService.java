...
public class GCMService extends IntentService {
    ...
    private static final String ACTION_REGISTER = "com.auzone.account.gcm.GCMService.REGISTER";
    private static final String ACTION_UNREGISTER = "com.auzone.account.gcm.GCMService.UNREGISTER";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            if (AuzoneAccount.DEBUG) Log.e(TAG, "Unable to register for GCM: " + e.toString());
            GCMUtil.clearRegistrationId(context);
            AuzoneAccountUtils.scheduleRetry(context, GCMUtil.getGCMPreferences(context), intent);
        }
    }
