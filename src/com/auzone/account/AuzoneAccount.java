...
public class AuzoneAccount extends Application implements Response.Listener<GetMinimumAppVersionResponse>, Response.ErrorListener {

    public static final String TAG = "AuzoneAccount";
    // Leave this off for release
    public static final boolean DEBUG = false;

    public static final String ACCOUNT_TYPE_AuzoneAccount = "com.auzone.account";
    public static final String AUTHTOKEN_TYPE_ACCESS = "com.auzone.account";
    public static final String AUTHTOKEN_EXPIRES_IN= "com.auzone.account.auth.expires_in";
    public static final String ACCOUNT_EXTRA_DEVICE_SALT = "com.auzone.account.auth.device_salt";
    public static final String ACCOUNT_EXTRA_HMAC_SECRET = "com.auzone.account.auth.hmac_secret";
    ...
    public static final String GCM_PREFERENCES = "com.auzone.account.gcm";
    public static final String AUTH_PREFERENCES = "com.auzone.account.auth";
    public static final String SETTINGS_PREFERENCES = "com.auzone.account_preferences";
    public static final String ENCRYPTION_PREFERENCES = "com.auzone.account.encryption";
    ...
    public static final int REQUEST_CODE_SETUP_AuzoneAccount = 1;
    ...
    private String mAuzoneAccountUri;
    ...
    public void onCreate() {
        super.onCreate();
        mAuzoneAccountUri = getString(R.string.auzoneaccount_uri);
        mStatusBarManager = (StatusBarManager)getSystemService(Context.STATUS_BAR_SERVICE);
        final DevicePolicyManager dpm = (DevicePolicyManager) getSystemService(Context.DEVICE_POLICY_SERVICE);
        final ComponentName deviceAdmin = new ComponentName(getApplicationContext(), AuzoneAccountAdminReceiver.class);
        ...
        if (AuzoneAccountUtils.isNetworkConnected(getApplicationContext())) {
            authClient.getMinimumAppVersion(this, this);
        }
    }

    public String getAuzoneAccountUri() {
        return mAuzoneAccountUri;
    }
    ...
    public void onResponse(GetMinimumAppVersionResponse getMinimumAppVersionResponse) {
        ...
        AuzoneAccountUtils.setMinimumAppVersion(getApplicationContext(), minimumVersion);
        if (AuzoneAccountUtils.getApplicationVersion(getApplicationContext()) < minimumVersion) {
            AuzoneAccountUtils.showIncompatibleVersionNotification(getApplicationContext());
        }
    }

    public static class AuzoneAccountAdminReceiver extends DeviceAdminReceiver {}
