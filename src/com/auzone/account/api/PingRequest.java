...
public class PingRequest extends AuzoneAccountRequest<PingResponse> {
    ...
    public PingRequest(Context context, String deviceId, String authToken, String carrier,
        ...
        addParameter(PARAM_CM_VERSION, AuzoneAccountUtils.getDisplayVersion());
        addParameter(PARAM_SALT, AuzoneAccountUtils.getDeviceSalt(context));
    }
