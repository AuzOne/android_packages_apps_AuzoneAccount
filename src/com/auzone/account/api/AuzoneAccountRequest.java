...
public abstract class AuzoneAccountRequest<T> extends Request<T> {
    ...
    protected AuzoneAccountRequest(String uri, Response.Listener<T> listener, Response.ErrorListener errorListener) {
        super(Method.POST, uri, errorListener);
        mListener = listener;
    }

    public AuzoneAccountRequest<T> addHeader(String name, String value) {
        mHeaders.put(name, value);
        return this;
    }

    public AuzoneAccountRequest<T> addParameter(String name, String value) {
